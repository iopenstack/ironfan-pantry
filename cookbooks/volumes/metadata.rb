...
recipe           "ironfan-volumes::default",                   "Placeholder -- see other recipes in ec2 cookbook"
recipe           "ironfan-volumes::mount",                     "Mount the volumes listed in node[:volumes]"
recipe           "ironfan-volumes::build_raid",                "Build a raid array of volumes as directed by node[:volumes]"
recipe           "ironfan-volumes::resize",                    "Resize mountables in node[:volumes] to fill the volume"
recipe           "ironfan-volumes::format",                    "Format the volumes listed in node[:volumes]"
