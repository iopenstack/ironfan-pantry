...
depends          "ironfan-zookeeper"
depends          "ironfan-ganglia"

recipe           "ironfan-hbase::backup_tables",               "Cron job to backup tables to S3"
recipe           "ironfan-hbase::default",                     "Base configuration for hbase"
recipe           "ironfan-hbase::master",                      "HBase Master"
recipe           "ironfan-hbase::regionserver",                "HBase Regionserver"
recipe           "ironfan-hbase::stargate",                    "HBase Stargate: HTTP frontend to HBase"
recipe           "ironfan-hbase::thrift",                      "HBase Thrift Listener"
recipe           "ironfan-hbase::minidash",                    "Simple dashboard for HBase config and state"
recipe           "ironfan-hbase::config_files",                "Finalizes the config, writes out the config files"
