...
recipe            "ironfan-mysql", "Includes the client recipe to configure a client"
recipe            "ironfan-mysql::client", "Installs packages required for mysql clients using run_action magic"
recipe            "ironfan-mysql::server", "Installs packages required for mysql servers w/o manual intervention"
recipe            "ironfan-mysql::server_ec2", "Performs EC2-specific mountpoint manipulation"
