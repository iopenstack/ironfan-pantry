...
depends          "ironfan-database", ">= 1.0.0"
depends          "ironfan-mysql", ">= 1.2.0"
depends          "ironfan-ufw", ">= 0.6.1"
depends          "ironfan-silverware"

recipe           "ironfan-zabbix::default",                    "Sets up Zabbix directory structure & user."
recipe           "ironfan-zabbix::agent_prebuild",             "Downloads, configures, & launches pre-built Zabbix agent"
recipe           "ironfan-zabbix::agent_source",               "Downloads, builds, configures, & launches Zabbix agent from source."
recipe           "ironfan-zabbix::agent",                      "Installs and launches Zabbix agent."
recipe           "ironfan-zabbix::firewall",                   "Configures firewall access between Zabbix server & agents."
recipe           "ironfan-zabbix::database_mysql",             "Configures Zabbix MySQL database."
recipe           "ironfan-zabbix::database",                   "Configures Zabbix database."
recipe           "ironfan-zabbix::server",                     "Installs and launches Zabbix server."
recipe           "ironfan-zabbix::server_source",              "Downloads, builds, configures, & launches Zabbix server from source."
recipe           "ironfan-zabbix::web",                        "Configures PHP-driven, reverse-proxied Zabbix web frontend."
recipe           "ironfan-zabbix::web_apache",                 "Configures PHP-driven, reverse-proxied Zabbix web frontend using Apache."
recipe           "ironfan-zabbix::web_nginx",                  "Configures PHP-driven, reverse-proxied Zabbix web frontend using nginx."
