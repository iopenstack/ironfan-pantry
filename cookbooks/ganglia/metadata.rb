...
recipe           "ironfan-ganglia::default",                   "Base configuration for ganglia"
recipe           "ironfan-ganglia::server",                    "Ganglia server -- contact point for all ganglia_agents"
recipe           "ironfan-ganglia::agent",                     "Ganglia agent  -- discovers and sends to its ganglia_server"
