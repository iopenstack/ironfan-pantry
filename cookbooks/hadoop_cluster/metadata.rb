...
depends          "ironfan-tuning"
depends          "ironfan-silverware"
depends          "ironfan-minidash"

recipe           "ironfan-hadoop_cluster::default",            "Base configuration for hadoop_cluster"
recipe           "ironfan-hadoop_cluster::add_cloudera_repo",  "Add Cloudera repo to package manager"
recipe           "ironfan-hadoop_cluster::config_files",       "Configure cluster"
recipe           "ironfan-hadoop_cluster::datanode",           "Installs Hadoop Datanode service"
recipe           "ironfan-hadoop_cluster::secondarynn",        "Installs Hadoop Secondary Namenode service"
recipe           "ironfan-hadoop_cluster::tasktracker",        "Installs Hadoop Tasktracker service"
recipe           "ironfan-hadoop_cluster::jobtracker",         "Installs Hadoop Jobtracker service"
recipe           "ironfan-hadoop_cluster::namenode",           "Installs Hadoop Namenode service"
recipe           "ironfan-hadoop_cluster::doc",                "Installs Hadoop documentation"
recipe           "ironfan-hadoop_cluster::hive",               "Installs Hive"
recipe           "ironfan-hadoop_cluster::hive_config",        "Installs Hive Config Files"
recipe           "ironfan-hadoop_cluster::hive_mysql_setup",   "Hive MySQL Setup"
recipe           "ironfan-hadoop_cluster::hue",                "Installs Hue"
recipe           "ironfan-hadoop_cluster::hue_config",         "Installs Hue Config Files"
recipe           "ironfan-hadoop_cluster::hue_mysql_setup",    "Hue MySQL Setup"
recipe           "ironfan-hadoop_cluster::hdfs_fuse",          "Installs Hadoop HDFS Fuse service (regular filesystem access to HDFS files)"
recipe           "ironfan-hadoop_cluster::wait_on_hdfs_safemode", "Wait on HDFS Safemode -- insert between cookbooks to ensure HDFS is available"
recipe           "ironfan-hadoop_cluster::minidash",           "Simple Dashboard"
recipe           "ironfan-hadoop_cluster::fake_topology",      "Pretend that groups of machines are on different racks so you can execute them without guilt"
