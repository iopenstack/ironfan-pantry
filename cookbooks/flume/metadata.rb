...
recipe           "ironfan-flume::default",                     "Base configuration for flume"
recipe           "ironfan-flume::master",                      "Configures Flume Master, installs and starts service"
recipe           "ironfan-flume::make_dirs",                   "Ties directories to available volumes"
recipe           "ironfan-flume::install_from_git",            "Install flume using designated git repo and branch"
recipe           "ironfan-flume::install_from_package",        "Install flume using package manager"
recipe           "ironfan-flume::agent",                       "Configures Flume Agent, installs and starts service"
recipe           "ironfan-flume::plugin-hbase_sink",           "Hbase Sink Plugin"
recipe           "ironfan-flume::plugin-jruby",                "Jruby Plugin"
recipe           "ironfan-flume::test_flow",                   "Test Flow"
recipe           "ironfan-flume::test_s3_source",              "Test S3 source"
recipe           "ironfan-flume::config_files",                "Finalizes the config, writes out the config files"
