...
recipe           "ironfan-cassandra::autoconf",                "Automatically configure nodes from chef-server information."
recipe           "ironfan-cassandra::ec2snitch",               "Automatically configure properties snitch for clusters on EC2."
recipe           "ironfan-cassandra::iptables",                "Automatically configure iptables rules for cassandra."
recipe           "ironfan-cassandra::authentication",          "Authentication"
recipe           "ironfan-cassandra::bintools",                "Bintools"
recipe           "ironfan-cassandra::client",                  "Client"
recipe           "ironfan-cassandra::default",                 "Base configuration for cassandra"
recipe           "ironfan-cassandra::install_from_git",        "Install From Git"
recipe           "ironfan-cassandra::install_from_package",    "Install From Package"
recipe           "ironfan-cassandra::install_from_release",    "Install From Release"
recipe           "ironfan-cassandra::jna_support",             "Jna Support"
recipe           "ironfan-cassandra::mx4j",                    "Mx4j"
recipe           "ironfan-cassandra::server",                  "Server"
recipe           "ironfan-cassandra::ruby_client",             "support gems for cassandra (incl. fauna/cassandra and apache/avro)"
